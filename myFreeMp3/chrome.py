...
def downloadSong(songTitle: str):
    ...
    browser = webdriver.Chrome(executable_path='~/.drivers/chromedriver', options=options) if os.path.exists("~/.drivers/chromedriver") else webdriver.Chrome(options=options)
